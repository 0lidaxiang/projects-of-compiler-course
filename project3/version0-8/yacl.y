...
%token <val> STR TRUE FALSE IDENTIFIER BOOL STRINGKEYWORD REAL INT VOID FOR 
...
%type  <val> value_declaration program primary_expression type_specifier declarator_list declarator expression  assignment_expression relational_expression additive_expression  parameter_list parameter_declaration    external_declaration unary_expression
// external_declaration exclusive_or_expression and_expression   equality_expression  inclusive_or_expression 
